  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MainPointerBloc, MainPointerState>(
      builder: (context, mainPointerState) {
        ...
        else if (mainPointerState is MainPointerStateEmptyList) {//todo про этот стейт нигде больше не написал, нужно добавлять аналогичный ивен, когда при загрузке понятно, что список пустой
        ...
        return Text("Error. Unhandeled state: $mainPointerState");
      },
    );
  }
}
